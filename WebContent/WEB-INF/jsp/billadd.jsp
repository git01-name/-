...
$(function(){
	...
	$("#billCode").blur(function(){
		...
		var name=$("#billCode").val();
		$.ajax({
			type:"GET",
			url:"${pageContext.request.contextPath}/jsp/billCodeExist",
			data:"name="+name,
			dataType:"json",
...
<div class="right">
     ...
     <div class="providerAdd">
         <form id="billForm" name="billForm" method="get" action="${pageContext.request.contextPath }/jsp/billa">
             <!--div的class 为error是验证错误，ok是验证成功-->
             <input type="hidden" name="method" value="add">
             <div class="">
                 <label for="billCode">订单编码：</label>
                 <input type="text" name="billCode" class="text" id="billCode" value=""> <span id=hxj></span>
				 <!-- 放置提示信息 -->
				 <font color="red"></font>
             </div>
             <div>
